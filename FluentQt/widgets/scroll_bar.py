...
from qtpy.QtCore import QObject, Qt, QEvent, QTimer, QDateTime, QPoint
from qtpy.QtWidgets import QAbstractScrollArea, QScrollArea, QApplication
...
class FSmoothScrollDelegate(QObject):
